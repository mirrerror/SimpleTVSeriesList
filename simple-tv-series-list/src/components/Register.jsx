            ...
            <div className="max-w-md w-full space-y-8 bg-white dark:bg-zinc-800 p-6 rounded-lg shadow-md">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div className="rounded-md shadow-sm -space-y-px">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                autoComplete="email"
                                required
                                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 dark:border-zinc-600 placeholder-gray-500 dark:placeholder-zinc-400 text-gray-900 dark:text-white dark:bg-zinc-700 focus:outline-none focus:ring-fuchsia-500 focus:border-fuchsia-500 focus:z-10 sm:text-sm"
                    ...
                    <div className="text-sm text-center">
                        <Link to="/login" className="font-medium text-fuchsia-600 hover:text-fuchsia-500 dark:text-fuchsia-400">
