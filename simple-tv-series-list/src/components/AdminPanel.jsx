...
export default function AdminPanel() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-zinc-900 py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white dark:bg-zinc-800 shadow overflow-hidden sm:rounded-md">
                    ...
                    <ul className="divide-y divide-gray-200 dark:divide-zinc-700">
                        {users.map((user) => (
                            <li key={user.id} className="px-4 py-4 flex items-center justify-between sm:px-6">
